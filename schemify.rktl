...
(linklet
 ...
 (define-values
  ...
  (lambda (vec_0)
    (let-values (((n_0) (vector-length vec_0)))
      (let-values (((new-vec_0) (make-vector (* 2 n_0)))) (begin (vector-copy! new-vec_0 0 vec_0 0 n_0) new-vec_0)))))
 (define-values
  (shrink-vector)
  (lambda (vec_1 i_0)
 ...
 (define-values
  ...
  (lambda (v_34 mutated_13)
    (let-values (((make-let-values_0)
                  (lambda (ids_18 rhs_16 body_11)
                    (if (if (pair? ids_18) (null? (cdr ids_18)) #f)
                      (list 'let (list (list (car ids_18) rhs_16)) body_11)
                      (list 'let-values (list (list ids_18 rhs_16)) body_11)))))
      (let-values (((v_35) v_34))
        (if (if (pair? v_35)
                ...
                (let-values (((d_142) (cdr v_35)))
                  (if (pair? d_142)
                    (if (let-values (((a_151) (car d_142)))
                          (if (pair? a_151)
                            (if (let-values (((a_152) (car a_151))) #t)
                              (let-values (((d_143) (cdr a_151))) (equal? '() d_143))
                              #f)
                            #f))
                      (let-values (((d_144) (cdr d_142))) #t)
                      #f)
                    #f))
                #f)
              #f)
          (let-values () v_34)
          (if (if (pair? v_35)
                (if (let-values (((a_153) (car v_35))) (equal? 'let-values a_153))
                  (let-values (((d_145) (cdr v_35)))
                    (if (pair? d_145)
                      (if (let-values (((a_154) (car d_145)))
                            (if (list? a_154)
                              (let-values (((lst_48) a_154))
                                (begin
                                  ...
                                  ((letrec-values (((for-loop_24)
                                   ...
                                   lst_48)))
                              #f))
                        (let-values (((d_148) (cdr d_145))) #t)
                        #f)
                      #f))
                  #f)
                #f)
            (let-values (((idss_8 rhss_39 bodys_2)
                          (let-values (((d_149) (cdr v_35)))
                            (let-values (((idss_9 rhss_40)
                                          (let-values (((a_157) (car d_149)))
                                            (let-values (((idss_10 rhss_41)
                                                          (let-values (((lst_50) a_157))
                                                            (begin
                                                              (if (list? lst_50)
                                                                (void)
                                         ...
                                         ((bodys_3) (let-values (((d_151) (cdr d_149))) d_151)))
                              (values idss_9 rhss_40 bodys_3)))))
              ((letrec-values (((loop_7)
                                (lambda (idss_16 rhss_47 binds_1)
                                  (if (null? (cdr rhss_47))
                                    (let-values ()
                                      (make-let-values_0 (car idss_16) (car rhss_47) (list* 'let binds_1 bodys_2)))
                                    (let-values ()
                                      (let-values (((ids_19) (car idss_16)))
                                        (make-let-values_0
                                         ids_19
                                         (car rhss_47)
                                         (loop_7
                                          (cdr idss_16)
                                          (cdr rhss_47)
                                          (append (map2 (lambda (id_8) (list id_8 id_8)) ids_19) binds_1)))))))))
                 loop_7)
               idss_8
               rhss_39
               null))
      ...
      ((letrec-values (((schemify_1)
                        (lambda (v_41)
                          (let-values (((v_42) v_41))
                            (if (if (pair? v_42)
                                  (if (let-values (((a_160) (car v_42))) (equal? 'lambda a_160))
                                    (let-values (((d_152) (cdr v_42)))
                                      (if (pair? d_152)
                                        (if (let-values (((a_161) (car d_152))) #t)
                                          (let-values (((d_153) (cdr d_152))) (list? d_153))
                                          #f)
                                        #f))
                                    #f)
                                  #f)
                              (let-values (((formals_0 body_12)
                                            (let-values (((d_154) (cdr v_42)))
                                              (let-values (((formals_1) (let-values (((a_162) (car d_154))) a_162))
                                                           ((body_13) (let-values (((d_155) (cdr d_154))) d_155)))
                                                (values formals_1 body_13)))))
                                (list* 'lambda formals_0 (map2 schemify_1 body_12)))
                              (if (if (pair? v_42)
                                    (if (let-values (((a_163) (car v_42))) (equal? 'case-lambda a_163))
                                      (let-values (((d_156) (cdr v_42)))
                                        (if (list? d_156)
                                          (let-values (((lst_52) d_156))
                                            (begin
                                      ...
                                      #f)
                                    #f)
                                (let-values (((formalss_0 bodys_4)
                                              (let-values (((d_158) (cdr v_42)))
                                                (let-values (((formalss_1 bodys_5)
                                                              (let-values (((lst_54) d_158))
                                                                (begin
                                                                  (if (list? lst_54)
                                                                    (void)
                                                                    (let-values () (check-list lst_54)))
                                                                  ((letrec-values (((for-loop_27)
                                                                                    (lambda (formalss_2 bodys_6 lst_55)
                                                                                      (if (pair? lst_55)
                                                                                        (let-values (((v_44)
                                                                                                      (unsafe-car
                                                                                                       lst_55))
                                                                                          ...
                                                                                          (let-values (((formalss_3
                                                                                            ...
                                                                                            (if (not #f)
                                                                                              ...
                                                                                              (values
                                                                                               formalss_3
                                                                                               bodys_7))))
                                                                                        (values formalss_2 bodys_6)))))
                                                                     for-loop_27)
                                                                   null
                                                                   null
                                                                   lst_54)))))
                                                  (values (reverse$1 formalss_1) (reverse$1 bodys_5))))))
                                  (list*
                                   'case-lambda
                                   (let-values (((lst_56) formalss_0) ((lst_57) bodys_4))
                                     (begin
                                       ...
                                       ((letrec-values (((for-loop_28)
                                        ...
                                        lst_57)))))
                                (if (if (pair? v_42)
                                      (if (let-values (((a_166) (car v_42))) (equal? 'define-values a_166))
                                        (let-values (((d_160) (cdr v_42)))
                                          (if (pair? d_160)
                                            (if (let-values (((a_167) (car d_160)))
                                                  (if (pair? a_167)
                                                    (if (let-values (((a_168) (car a_167))) #t)
                                                      (let-values (((d_161) (cdr a_167)))
                                                        (if (pair? d_161)
                                                          (if (let-values (((a_169) (car d_161))) #t)
                                                            (let-values (((d_162) (cdr d_161)))
                                                              (if (pair? d_162)
                                                                (if (let-values (((a_170) (car d_162))) #t)
                                                                  (let-values (((d_163) (cdr d_162))) (list? d_163))
                                                                  #f)
                                                                #f))
                                                            #f)
                                                          #f))
                                                      #f)
                                                    #f))
                                              (let-values (((d_164) (cdr d_160)))
                                                (if (pair? d_164)
                                                  (if (let-values (((a_171) (car d_164)))
                                                        (if (pair? a_171)
                                                          (if (let-values (((a_172) (car a_171)))
                                                                (equal? 'let-values a_172))
                                                            (let-values (((d_165) (cdr a_171)))
                                                              (if (pair? d_165)
                                                                (if (let-values (((a_173) (car d_165)))
                                                                      (if (pair? a_173)
                                                                        (if (let-values (((a_174) (car a_173)))
                                                                              (if (pair? a_174)
                                                                                (if (let-values (((a_175) (car a_174)))
                                                                                      (if (pair? a_175)
                                                                                        (if (let-values (((a_176)
                                                                                                          (car a_175)))
                                                                                              #t)
                                                                                  ...
                                                                                  #f)
                                                                                #f))
                                                                          (let-values (((d_173) (cdr a_173)))
                                                                            (equal? '() d_173))
                                                                          #f)
                                                                        #f))
                                                                  (let-values (((d_174) (cdr d_165)))
                                                                    (if (pair? d_174)
                                                                      (if (let-values (((a_182) (car d_174)))
                                                                            (if (pair? a_182)
                                                                              (if (let-values (((a_183) (car a_182)))
                                                                                    (equal? 'values a_183))
                                                                                (let-values (((d_175) (cdr a_182)))
                                                                                  (if (pair? d_175)
                                                                                    (if (let-values (((a_184)
                                                                                                      (car d_175)))
                                                                                          #t)
                                                            ...
                                                            #f)
                                                          #f))
                                                    (let-values (((d_180) (cdr d_164))) (equal? '() d_180))
                                                    #f)
                                                  #f))
                                              #f)
                                            #f))
                                  ...
                                  (let-values (((struct:s_3
                                                 ...
                                                 ?2_6
                                                 make-acc/muts_6)
                                                (let-values (((d_181) (cdr v_42)))
                                                  (let-values (((struct:s_4 make-s_5 s?_6 acc/muts_6)
                                                                (let-values (((a_187) (car d_181)))
                                                                  (let-values (((struct:s_5)
                                                                                (let-values (((a_188) (car a_187)))
                                                                                  a_188))
                                                                               ((make-s_6 s?_7 acc/muts_7)
                                                                                (let-values (((d_182) (cdr a_187)))
                                                                                  (let-values (((make-s_7)
                                                                                                (let-values (((a_189)
                                                                                                              (car
                                                                                                               d_182)))
                                                               ...
                                                               ((struct:_7
                                                                 ...
                                                                 ?2_7
                                                                 make-acc/muts_7)
                                                                (let-values (((d_185) (cdr d_181)))
                                                                  (let-values (((a_191) (car d_185)))
                                                                    (let-values (((d_186) (cdr a_191)))
                                  ...
                                  (if (if (pair? v_42)
                                        (if (let-values (((a_215) (car v_42))) (equal? 'define-values a_215))
                                          (let-values (((d_209) (cdr v_42)))
                                            (if (pair? d_209)
                                              (if (let-values (((a_216) (car d_209)))
                                                    (if (pair? a_216)
                                                      (if (let-values (((a_217) (car a_216))) #t)
                                                        (let-values (((d_210) (cdr a_216))) (equal? '() d_210))
                                                        #f)
                                                      #f))
                                                (let-values (((d_211) (cdr d_209)))
                                                  (if (pair? d_211)
                                                    (if (let-values (((a_218) (car d_211))) #t)
                                                      (let-values (((d_212) (cdr d_211))) (equal? '() d_212))
                                                      #f)
                                                    #f))
                                                #f)
                                              #f))
                                          #f)
                                        #f)
                                    (let-values (((id_9 rhs_17)
                                                  (let-values (((d_213) (cdr v_42)))
                                                    (let-values (((id_10)
                                                                  (let-values (((a_219) (car d_213)))
                                                                    (let-values (((a_220) (car a_219))) a_220)))
                                                                 ((rhs_18)
                                                                  (let-values (((d_214) (cdr d_213)))
                                                                    (let-values (((a_221) (car d_214))) a_221))))
                                                      (values id_10 rhs_18)))))
                                      (list 'define id_9 (schemify_1 rhs_17)))
                                    (if (if (pair? v_42)
                                          (if (let-values (((a_222) (car v_42))) (equal? 'define-values a_222))
                                            (let-values (((d_215) (cdr v_42)))
                                              (if (pair? d_215)
                                                (if (let-values (((a_223) (car d_215))) #t)
                                                  (let-values (((d_216) (cdr d_215)))
                                                    (if (pair? d_216)
                                                      (if (let-values (((a_224) (car d_216))) #t)
                                                        (let-values (((d_217) (cdr d_216))) (equal? '() d_217))
                                                        #f)
                                                      #f))
                                                  #f)
                                                #f))
                                      ...
                                      (let-values (((ids_20 rhs_19)
                                                    (let-values (((d_218) (cdr v_42)))
                                                      (let-values (((ids_21) (let-values (((a_225) (car d_218))) a_225))
                                                                   ((rhs_20)
                                                                    (let-values (((d_219) (cdr d_218)))
                                                                      (let-values (((a_226) (car d_219))) a_226))))
                                                        (values ids_21 rhs_20)))))
                                        (list 'define-values ids_20 (schemify_1 rhs_19)))
                                      (if (if (pair? v_42)
                                            (if (let-values (((a_227) (car v_42))) (equal? 'quote a_227))
                                              (let-values (((d_220) (cdr v_42)))
                                                (if (pair? d_220)
                                                  (if (let-values (((a_228) (car d_220))) #t)
                                                    (let-values (((d_221) (cdr d_220))) (equal? '() d_221))
                                                    #f)
                                                  #f))
                                              #f)
                                            #f)
                                        (let-values () v_41)
                                        (if (if (pair? v_42)
                                              (if (let-values (((a_229) (car v_42))) (equal? 'let-values a_229))
                                                (let-values (((d_222) (cdr v_42)))
                                                  (if (pair? d_222)
                                                    (if (let-values (((a_230) (car d_222))) (equal? '() a_230))
                                                      (let-values (((d_223) (cdr d_222)))
                                                        (if (pair? d_223)
                                                          (if (let-values (((a_231) (car d_223))) #t)
                                                            (let-values (((d_224) (cdr d_223))) (equal? '() d_224))
                                                            #f)
                                                          #f))
                                                      #f)
                                                    #f))
                                              ...
                                              #f)
                                          (let-values (((body_15)
                                                        (let-values (((d_225) (cdr v_42)))
                                                          (let-values (((d_226) (cdr d_225)))
                                                            (let-values (((a_232) (car d_226))) a_232)))))
                                            (schemify_1 body_15))
                                          (if (if (pair? v_42)
                                                (if (let-values (((a_233) (car v_42))) (equal? 'let-values a_233))
                                                  (let-values (((d_227) (cdr v_42)))
                                                    (if (pair? d_227)
                                                      (if (let-values (((a_234) (car d_227))) (equal? '() a_234))
                                                        (let-values (((d_228) (cdr d_227))) (list? d_228))
                                                        #f)
                                                      #f))
                                                  #f)
                                                #f)
                                            (let-values (((bodys_11)
                                                          (let-values (((d_229) (cdr v_42)))
                                                            (let-values (((d_230) (cdr d_229))) d_230))))
                                              (list* 'begin (map2 schemify_1 bodys_11)))
                                            (if (if (pair? v_42)
                                                  (if (let-values (((a_235) (car v_42))) (equal? 'let-values a_235))
                                                    (let-values (((d_231) (cdr v_42)))
                                                      (if (pair? d_231)
                                                        (if (let-values (((a_236) (car d_231)))
                                                              (if (list? a_236)
                                                                (let-values (((lst_64) a_236))
                                                                  (begin
                                                                    (if (list? lst_64)
                                                                      (void)
                                                                    ...
                                                                    ((letrec-values (((for-loop_31)
                                                                     ...
                                                                     lst_64)))
                                                                #f))
                                                          (let-values (((d_235) (cdr d_231))) (list? d_235))
                                                          #f)
                                                        #f))
                                                    #f)
                                                  #f)
                                              (let-values (((ids_22 rhss_48 bodys_12)
                                                            (let-values (((d_236) (cdr v_42)))
                                                              (let-values (((ids_23 rhss_49)
                                                                            (let-values (((a_240) (car d_236)))
                                                                              (let-values (((ids_24 rhss_50)
                                                                                            (let-values (((lst_66)
                                                                                                          a_240))
                                                                                              (begin
                                                                                                (if (list? lst_66)
                                                                                ...
                                                                                (values
                                                                                 ...
                                                                                 (reverse$1 rhss_50)))))
                                                                           ((bodys_13)
                                                                            (let-values (((d_238) (cdr d_236))) d_238)))
                                                                (values ids_23 rhss_49 bodys_13)))))
                                                (let-values (((new-procs_1)
                                                              (let-values (((lst_68) ids_22) ((lst_69) rhss_48))
                                                                (begin
                                                                  (if (list? lst_68)
                                                                    (void)
                                                  ...
                                                  (let-values (((body-schemify_0)
                                                    ...
                                                    (left-to-right/let
                                                     (list*
                                                      'let
                                                      (let-values (((lst_72) ids_22) ((lst_73) rhss_48))
                                                        (begin
                                                          ...
                                                          ((letrec-values (((for-loop_34)
                                                           ...
                                                           lst_72
                                                           lst_73)))
                                                      (map2 body-schemify_0 bodys_12))
                                                     mutated_15))))
                                              (if (if (pair? v_42)
                                                    (if (let-values (((a_244) (car v_42))) (equal? 'let-values a_244))
                                                      (let-values (((d_239) (cdr v_42)))
                                                        (if (pair? d_239)
                                                          (if (let-values (((a_245) (car d_239)))
                                                                (if (pair? a_245)
                                                                  (if (let-values (((a_246) (car a_245)))
                                                                        (if (pair? a_246)
                                                                          (if (let-values (((a_247) (car a_246)))
                                                                                (equal? '() a_247))
                                                                            (let-values (((d_240) (cdr a_246)))
                                                                              (if (pair? d_240)
                                                                                (if (let-values (((a_248) (car d_240)))
                                                                                      (if (pair? a_248)
                                                                                        (if (let-values (((a_249)
                                                                                                          (car a_248)))
                                                                                              (equal? 'begin a_249))
                                                                                          ...
                                                                                          #f)
                                                                                        #f))
                                                                                  (let-values (((d_246) (cdr d_240)))
                                                                                    (equal? '() d_246))
                                                                                  #f)
                                                                                #f))
                                                                            #f)
                                                                          #f))
                                                                    (let-values (((d_247) (cdr a_245)))
                                                                      (equal? '() d_247))
                                                                    #f)
                                                                  #f))
                                                            (let-values (((d_248) (cdr d_239))) (list? d_248))
                                                            #f)
                                                          #f))
                                                      #f)
                                                    #f)
                                                (let-values (((rhss_56 bodys_14)
                                                              (let-values (((d_249) (cdr v_42)))
                                                                (let-values (((rhss_57)
                                                                              (let-values (((a_254) (car d_249)))
                                                                                (let-values (((a_255) (car a_254)))
                                                                                  (let-values (((d_250) (cdr a_255)))
                                                                                    (let-values (((a_256) (car d_250)))
                                                                                      (let-values (((d_251)
                                                                                                    (cdr a_256)))
                                                                                        (let-values (((a_257)
                                                                                                      (car d_251)))
                                                                                          a_257)))))))
                                                                             ((bodys_15)
                                                                              (let-values (((d_252) (cdr d_249)))
                                                                                d_252)))
                                                                  (values rhss_57 bodys_15)))))
                                                  (list*
                                                   'begin
                                                   (qq-append (map2 schemify_1 rhss_56) (map2 schemify_1 bodys_14))))
                                                (if (if (pair? v_42)
                                                      (if (let-values (((a_258) (car v_42))) (equal? 'let-values a_258))
                                                        (let-values (((d_253) (cdr v_42)))
                                                          (if (pair? d_253)
                                                            (if (let-values (((a_259) (car d_253)))
                                                                  (if (list? a_259)
                                                                    (let-values (((lst_76) a_259))
                                                                      (begin
                                                                        (if (list? lst_76)
                                                                          (void)
                                                                        ...
                                                                        ((letrec-values (((for-loop_35)
                                                                         ...
                                                                         lst_76)))
                                                                    #f))
                                                              (let-values (((d_256) (cdr d_253))) (list? d_256))
                                                              #f)
                                                            #f))
                                                        #f)
                                                      #f)
                                                  (let-values (((idss_17 rhss_58 bodys_16)
                                                                (let-values (((d_257) (cdr v_42)))
                                                                  (let-values (((idss_18 rhss_59)
                                                                                (let-values (((a_262) (car d_257)))
                                                                                  (let-values (((idss_19 rhss_60)
                                                                                    ...
                                                                                    (values
                                                                                     ...
                                                                                     (reverse$1 rhss_60)))))
                                                                               ((bodys_17)
                                                                                (let-values (((d_259) (cdr d_257)))
                                                                                  d_259)))
                                                                    (values idss_18 rhss_59 bodys_17)))))
                                                    (left-to-right/let-values
                                                     (list*
                                                      'let-values
                                                      (let-values (((lst_80) idss_17) ((lst_81) rhss_58))
                                                        (begin
                                                          ...
                                                          ((letrec-values (((for-loop_37)
                                                           ...
                                                           lst_80
                                                           lst_81)))
                                                      (map2 schemify_1 bodys_16))
                                                     mutated_15))
                                                  (if (if (pair? v_42)
                                                        (if (let-values (((a_265) (car v_42)))
                                                              (equal? 'letrec-values a_265))
                                                          (let-values (((d_260) (cdr v_42)))
                                                            (if (pair? d_260)
                                                              (if (let-values (((a_266) (car d_260)))
                                                                    (if (list? a_266)
                                                                      (let-values (((lst_84) a_266))
                                                                        (begin
                                                                          (if (list? lst_84)
                                                                            (void)
                                                                          ...
                                                                          ((letrec-values (((for-loop_38)
                                                                           ...
                                                                           lst_84)))
                                                                      #f))
                                                                (let-values (((d_264) (cdr d_260))) (list? d_264))
                                                                #f)
                                                              #f))
                                                          #f)
                                                        #f)
                                                    (let-values (((ids_31 rhss_66 bodys_18)
                                                                  (let-values (((d_265) (cdr v_42)))
                                                                    (let-values (((ids_32 rhss_67)
                                                                                  (let-values (((a_270) (car d_265)))
                                                                                    (let-values (((ids_33 rhss_68)
                                                                                                  (let-values (((lst_86)
                                                                                                                a_270))
                                                                                                    (begin
                                                                                                      (if (list? lst_86)
                                                                                      ...
                                                                                      (values
                                                                                       ...
                                                                                       (reverse$1 rhss_68)))))
                                                                                 ((bodys_19)
                                                                                  (let-values (((d_267) (cdr d_265)))
                                                                                    d_267)))
                                                                      (values ids_32 rhss_67 bodys_19)))))
                                                      (let-values (((new-procs_2)
                                                                    (let-values (((lst_88) ids_31) ((lst_89) rhss_66))
                                                                      (begin
                                                                        (if (list? lst_88)
                                                                          (void)
                                                        ...
                                                        (let-values (((schemify_2)
                                                          ...
                                                          (list*
                                                           'letrec*
                                                           (let-values (((lst_92) ids_31) ((lst_93) rhss_66))
                                                             (begin
                                                               (if (list? lst_92)
                                                                 (void)
                                                               ...
                                                               ((letrec-values (((for-loop_41)
                                                                ...
                                                                lst_92
                                                                lst_93)))
                                                           (map2 schemify_2 bodys_18)))))
                                                    (if (if (pair? v_42)
                                                          (if (let-values (((a_274) (car v_42)))
                                                                (equal? 'letrec-values a_274))
                                                            (let-values (((d_268) (cdr v_42)))
                                                              (if (pair? d_268)
                                                                (if (let-values (((a_275) (car d_268)))
                                                                      (if (list? a_275)
                                                                        (let-values (((lst_96) a_275))
                                                                          (begin
                                                                            (if (list? lst_96)
                                                                              (void)
                                                                            ...
                                                                            ((letrec-values (((for-loop_42)
                                                                             ...
                                                                             lst_96)))
                                                                        #f))
                                                                  (let-values (((d_271) (cdr d_268))) (list? d_271))
                                                                  #f)
                                                                #f))
                                                            #f)
                                                          #f)
                                                      (let-values (((idss_25 rhss_74 bodys_20)
                                                                    (let-values (((d_272) (cdr v_42)))
                                                                      (let-values (((idss_26 rhss_75)
                                                                                    (let-values (((a_278) (car d_272)))
                                                                                      (let-values (((idss_27 rhss_76)
                                                                                        ...
                                                                                        (values
                                                                                         ...
                                                                                         (reverse$1 rhss_76)))))
                                                                                   ((bodys_21)
                                                                                    (let-values (((d_274) (cdr d_272)))
                                                                                      d_274)))
                                                                        (values idss_26 rhss_75 bodys_21)))))
                                                        (list*
                                                         'letrec-values
                                                      ...
                                                      (if (if (pair? v_42)
                                                            (if (let-values (((a_281) (car v_42))) (equal? 'if a_281))
                                                              (let-values (((d_275) (cdr v_42)))
                                                                (if (pair? d_275)
                                                                  (if (let-values (((a_282) (car d_275))) #t)
                                                                    (let-values (((d_276) (cdr d_275)))
                                                                      (if (pair? d_276)
                                                                        (if (let-values (((a_283) (car d_276))) #t)
                                                                          (let-values (((d_277) (cdr d_276)))
                                                                            (if (pair? d_277)
                                                                              (if (let-values (((a_284) (car d_277)))
                                                                                    #t)
                                                                                (let-values (((d_278) (cdr d_277)))
                                                                                  (equal? '() d_278))
                                                                                #f)
                                                                              #f))
                                                                          #f)
                                                        ...
                                                        (let-values (((tst_0 thn_0 els_0)
                                                          ...
                                                          (list
                                                           ...
                                                           (schemify_1 els_0)))
                                                        (if (if (pair? v_42)
                                                              (if (let-values (((a_288) (car v_42)))
                                                                    (equal? 'with-continuation-mark a_288))
                                                                (let-values (((d_282) (cdr v_42)))
                                                                  (if (pair? d_282)
                                                                    (if (let-values (((a_289) (car d_282))) #t)
                                                                      (let-values (((d_283) (cdr d_282)))
                                                                        (if (pair? d_283)
                                                                          (if (let-values (((a_290) (car d_283))) #t)
                                                                            (let-values (((d_284) (cdr d_283)))
                                                                              (if (pair? d_284)
                                                                                (if (let-values (((a_291) (car d_284)))
                                                                                      #t)
                                                                                  (let-values (((d_285) (cdr d_284)))
                                                                                    (equal? '() d_285))
                                                                                  #f)
                                                                                #f))
                                                                            #f)
                                                                ...
                                                                #f)
                                                              #f)
                                                          (let-values (((key_0 val_0 body_16)
                                                                                                        ...
                                                                                                        (let-values (((d_288)
                                                                                                          ...
                                                                                                          (let-values (((a_294)
                                                                                                                        (car
                                                                                                                         d_288)))
                                                                                                            a_294))))
                                                                                            (values val_2 body_18)))))
                                                                            (values key_1 val_1 body_17)))))
                                                            (list
                                                             ...
                                                             (schemify_1 body_16)))
                                                          (if (if (pair? v_42)
                                                                (if (let-values (((a_295) (car v_42)))
                                                                      (equal? 'begin a_295))
                                                                  (let-values (((d_289) (cdr v_42))) (list? d_289))
                                                                  #f)
                                                                #f)
                                                            (let-values (((exps_0)
                                                                          (let-values (((d_290) (cdr v_42))) d_290)))
                                                              (list* 'begin (map2 schemify_1 exps_0)))
                                                            (if (if (pair? v_42)
                                                                  (if (let-values (((a_296) (car v_42)))
                                                                        (equal? 'begin0 a_296))
                                                                    (let-values (((d_291) (cdr v_42))) (list? d_291))
                                                                    #f)
                                                                  #f)
                                                              (let-values (((exps_1)
                                                                            (let-values (((d_292) (cdr v_42))) d_292)))
                                                                (list* 'begin0 (map2 schemify_1 exps_1)))
                                                              (if (if (pair? v_42)
                                                                    (if (let-values (((a_297) (car v_42)))
                                                                          (equal? 'set! a_297))
                                                                      (let-values (((d_293) (cdr v_42)))
                                                                        (if (pair? d_293)
                                                                          (if (let-values (((a_298) (car d_293))) #t)
                                                                            (let-values (((d_294) (cdr d_293)))
                                                                              (if (pair? d_294)
                                                                                (if (let-values (((a_299) (car d_294)))
                                                                                      #t)
                                                                ...
                                                                (let-values (((id_15 rhs_27)
                                                                              (let-values (((d_296) (cdr v_42)))
                                                                                (let-values (((id_16)
                                                                                  ...
                                                                                  (values id_16 rhs_28)))))
                                                                  (let-values (((ex-id_0)
                                                                                (hash-ref exports_6 id_15 #f)))
                                                                    (if ex-id_0
                                                                      (list 'variable-set! ex-id_0 (schemify_1 rhs_27))
                                                                      (list 'set! id_15 (schemify_1 rhs_27)))))
                                                                (if (if (pair? v_42)
                                                                      (if (let-values (((a_302) (car v_42)))
                                                                            (equal?
                                                                             'variable-reference-constant?
                                                                             a_302))
                                                                        (let-values (((d_298) (cdr v_42)))
                                                                          (if (pair? d_298)
                                                                            (if (let-values (((a_303) (car d_298)))
                                                                                  (if (pair? a_303)
                                                                                    (if (let-values (((a_304)
                                                                                                      (car a_303)))
                                                                                          (equal?
                                                                      ...
                                                                      #f)
                                                                  (let-values (((id_17)
                                                                                (let-values (((d_302) (cdr v_42)))
                                                                                  (let-values (((a_306) (car d_302)))
                                                                                    (let-values (((d_303) (cdr a_306)))
                                                                                      (let-values (((a_307)
                                                                                                    (car d_303)))
                                                                                        a_307))))))
                                                                    (not (hash-ref mutated_15 id_17 #f)))
                                                                  (if (if (pair? v_42)
                                                                        (if (let-values (((a_308) (car v_42)))
                                                                              (equal? '#%variable-reference a_308))
                                                                          (let-values (((d_304) (cdr v_42))) #t)
                                                                          #f)
                                                                        #f)
                                                                    (let-values () v_41)
                                                                    (if (if (pair? v_42)
                                                                          (if (let-values (((a_309) (car v_42))) #t)
                                                                            (let-values (((d_305) (cdr v_42)))
                                                                              (list? d_305))
                                                                            #f)
                                                                          #f)
                    ...
                    (begin
                      ...
                      ((letrec-values (((for-loop_45)
                                        (lambda (pending_1 lst_105)
                                          (if (pair? lst_105)
                                            (let-values (((v_56) (unsafe-car lst_105)) ((rest_56) (unsafe-cdr lst_105)))
                                              (let-values (((pending_2)
                                                            (let-values (((pending_3) pending_1))
                                                              (let-values (((pending_4)
                                                                ...
                                                                (values pending_4)))))
                                                (if (not #f) (for-loop_45 pending_2 rest_56) pending_2)))
                                            pending_1))))
                         for-loop_45)
                       (hasheq)
                       lst_104)))))
                                ...
                                (begin
                                  ...
                                  ((letrec-values (((for-loop_47)
                                                    (lambda (mutated_17 lst_109)
                                                      (if (pair? lst_109)
                                                        (let-values (((v_58) (unsafe-car lst_109))
                                                                     ((rest_58) (unsafe-cdr lst_109)))
                                                                          ...
                                                                          (let-values (((mutated_20)
                                                                                        (let-values ()
                                                                                          (find-mutated
                                                                                           ...
                                                                                           pending_9))))
                                                                            (values mutated_20)))))
                                                            (if (not #f) (for-loop_47 mutated_18 rest_58) mutated_18)))
                                                        mutated_17))))
                                     for-loop_47)
                                   mutated_16
                                   lst_108))))
                            (let-values ()
                              (let-values (((form_0) (car l_13)))
                                (let-values (((v_59) form_0))
                                  (if (if (pair? v_59)
                                        (if (let-values (((a_316) (car v_59))) (equal? 'define-values a_316))
                                          (let-values (((d_312) (cdr v_59)))
                                            (if (pair? d_312)
                                              (if (let-values (((a_317) (car d_312))) #t)
                                                (let-values (((d_313) (cdr d_312)))
                                                  (if (pair? d_313)
                                                    (if (let-values (((a_318) (car d_313))) #t)
                                                      (let-values (((d_314) (cdr d_313))) (equal? '() d_314))
                                                      #f)
                                                    #f))
                                                #f)
                                              #f))
                                          #f)
                                        #f)
                                    (let-values (((ids_42 rhs_31)
                                                  (let-values (((d_315) (cdr v_59)))
                                                    (let-values (((ids_43) (let-values (((a_319) (car d_315))) a_319))
                                                                 ((rhs_32)
                                                                  (let-values (((d_316) (cdr d_315)))
                                                                    (let-values (((a_320) (car d_316))) a_320))))
                                                      (values ids_43 rhs_32)))))
                                      (let-values (((next-pending_0)
                                                    (let-values (((lst_110) ids_42))
                                                      (begin
                                                        ...
                                                        ((letrec-values (((for-loop_48)
                                                                                              ...
                                                                                              (let-values (((pending_12)
                                                                                                ...
                                                                                                (let-values (((pending_13)
                                                                                                  ...
                                                                                                  (values
                                                                                                   pending_13)))))
                                                                                  (if (not #f)
                                                                                    (for-loop_48 pending_11 rest_59)
                                                                                    pending_11)))
                                                                              pending_10))))
                                                           for-loop_48)
                                                         pending_9
                                                         lst_110)))))
                                        (if (lambda? rhs_31)
                                          (loop_9 mutated_16 (cdr l_13) (cons rhs_31 delay-l_0) next-pending_0)
                                                        ...
                                                        (let-values (((lst_112) delay-l_0))
                                                          (begin
                                                            ...
                                                            ((letrec-values (((for-loop_49)
                                                                                                  ...
                                                                                                  (let-values (((mutated_24)
                                                                                                    ...
                                                                                                    (let-values (((mutated_25)
                                                                                                      ...
                                                                                                      (values
                                                                                                       mutated_25)))))
                                                                                      (if (not #f)
                                                                                        (for-loop_49 mutated_23 rest_60)
                                                                                        mutated_23)))
                                                                                  mutated_22))))
                                                               for-loop_49)
                                                             mutated_16
                                                             lst_112)))))
                                            (loop_9
                                             (find-mutated rhs_31 mutated_21 pending_9)
                                             (cdr l_13)
                                             null
                                             next-pending_0)))))
                                    (let-values ()
                                                      ...
                                                      (begin
                                                        ...
                                                        ((letrec-values (((for-loop_50)
                                                                          (lambda (mutated_27 lst_115)
                                                                            (if (pair? lst_115)
                                                                              (let-values (((v_61) (unsafe-car lst_115))
                                                                                           ((rest_61)
                                                                                            (unsafe-cdr lst_115)))
                                                                                              ...
                                                                                              (let-values (((mutated_29)
                                                                                                ...
                                                                                                (let-values (((mutated_30)
                                                                                                  ...
                                                                                                  (values
                                                                                                   mutated_30)))))
                                                                                  (if (not #f)
                                                                                    (for-loop_50 mutated_28 rest_61)
                                                                                    mutated_28)))
                                                                              mutated_27))))
                                                           for-loop_50)
                                                         mutated_16
 ...
 (define-values
  ...
  (lambda (v_62 mutated_31 pending_14)
    (let-values (((v_63) v_62))
      (if (if (pair? v_63)
            (if (let-values (((a_321) (car v_63))) (equal? 'lambda a_321))
              (let-values (((d_317) (cdr v_63)))
                (if (pair? d_317)
                  (if (let-values (((a_322) (car d_317))) #t) (let-values (((d_318) (cdr d_317))) (list? d_318)) #f)
                  #f))
              #f)
            #f)
        (let-values (((formals_3 body_19)
                      (let-values (((d_319) (cdr v_63)))
                        (let-values (((formals_4) (let-values (((a_323) (car d_319))) a_323))
                                     ((body_20) (let-values (((d_320) (cdr d_319))) d_320)))
                          (values formals_4 body_20)))))
          (find-mutated* body_19 mutated_31 pending_14))
        (if (if (pair? v_63)
              (if (let-values (((a_324) (car v_63))) (equal? 'case-lambda a_324))
                (let-values (((d_321) (cdr v_63)))
                  (if (list? d_321)
                    (let-values (((lst_116) d_321))
                      (begin
                        (if (list? lst_116) (void) (let-values () (check-list lst_116)))
                        ((letrec-values (((for-loop_51)
                                          (lambda (result_53 lst_117)
                                            (if (pair? lst_117)
                                              (let-values (((v_64) (unsafe-car lst_117))
                                                                                ...
                                                                                (let-values ()
                                                                                  (if (pair? v_64)
                                                                                    (if (let-values (((a_325)
                                                                                                      (car v_64)))
                                                                                          #t)
                                                                                      (let-values (((d_322) (cdr v_64)))
                                                                                        (list? d_322))
                                                                                      #f)
                                                                                    #f)))))
                                                                  (values result_55)))))
                                                  (if (if (not ((lambda x_15 (not result_54)) v_64)) (not #f) #f)
                                                    (for-loop_51 result_54 rest_62)
                                                    result_54)))
                                              result_53))))
                           for-loop_51)
                         #t
                ...
                #f)
              #f)
          (let-values (((formalss_7 bodys_22)
                        (let-values (((d_323) (cdr v_63)))
                          (let-values (((formalss_8 bodys_23)
                                        (let-values (((lst_118) d_323))
                                          (begin
                                            (if (list? lst_118) (void) (let-values () (check-list lst_118)))
                                            ((letrec-values (((for-loop_52)
                                                              (lambda (formalss_9 bodys_24 lst_119)
                                                                (if (pair? lst_119)
                                                                  (let-values (((v_65) (unsafe-car lst_119))
                                                                               ((rest_63) (unsafe-cdr lst_119)))
                                                                    (let-values (((formalss_10 bodys_25)
                                                                                  (let-values (((formalss_11)
                                                                                                formalss_9)
                                                                                               ((bodys_26) bodys_24))
                                                                                    (let-values (((formalss_12 bodys_27)
                                                                                                  (let-values ()
                                                                                                    (let-values (((formalss23_0
                                                                                                      ...
                                                                                                      (values
                                                                                                       ...
                                                                                                       (cons
                                                                                                        bodys24_0
                                                                                                        bodys_26))))))
                                                                                      (values formalss_12 bodys_27)))))
                                                                      (if (not #f)
                                                                        (for-loop_52 formalss_10 bodys_25 rest_63)
                                                                        (values formalss_10 bodys_25))))
                                                                  (values formalss_9 bodys_24)))))
                                               for-loop_52)
                                             null
                                             null
                                             lst_118)))))
                            (values (reverse$1 formalss_8) (reverse$1 bodys_23))))))
            (let-values (((lst_120) bodys_22))
              (begin
                (if (list? lst_120) (void) (let-values () (check-list lst_120)))
                ((letrec-values (((for-loop_53)
                                  (lambda (mutated_32 lst_121)
                                    (if (pair? lst_121)
                                      (let-values (((body_21) (unsafe-car lst_121)) ((rest_64) (unsafe-cdr lst_121)))
                                        (let-values (((mutated_33)
                                                      (let-values (((mutated_34) mutated_32))
                                                        (let-values (((mutated_35)
                                                                      (let-values ()
                                                                        (find-mutated* body_21 mutated_34 pending_14))))
                                                          (values mutated_35)))))
                                          (if (not #f) (for-loop_53 mutated_33 rest_64) mutated_33)))
                                      mutated_32))))
                   for-loop_53)
                 mutated_31
                 lst_120))))
          (if (if (pair? v_63)
                (if (let-values (((a_327) (car v_63))) (equal? 'define-values a_327))
                  (let-values (((d_325) (cdr v_63)))
                    (if (pair? d_325)
                      (if (let-values (((a_328) (car d_325))) #t)
                        (let-values (((d_326) (cdr d_325)))
                          (if (pair? d_326)
                            (if (let-values (((a_329) (car d_326))) #t)
                              (let-values (((d_327) (cdr d_326))) (equal? '() d_327))
                              #f)
                            #f))
                        #f)
                      #f))
                  #f)
                #f)
            (let-values (((ids_44 rhs_33)
                          (let-values (((d_328) (cdr v_63)))
                            (let-values (((ids_45) (let-values (((a_330) (car d_328))) a_330))
                                         ((rhs_34)
                                          (let-values (((d_329) (cdr d_328)))
                                            (let-values (((a_331) (car d_329))) a_331))))
                              (values ids_45 rhs_34)))))
              (find-mutated rhs_33 mutated_31 pending_14))
            (if (if (pair? v_63)
                  (if (let-values (((a_332) (car v_63))) (equal? 'quote a_332))
                    (let-values (((d_330) (cdr v_63)))
                      (if (pair? d_330)
                        (if (let-values (((a_333) (car d_330))) #t)
                          (let-values (((d_331) (cdr d_330))) (equal? '() d_331))
                          #f)
                        #f))
                    #f)
                  #f)
              ...
              (if (if (pair? v_63)
                    (if (let-values (((a_334) (car v_63))) (equal? 'let-values a_334))
                      (let-values (((d_332) (cdr v_63)))
                        (if (pair? d_332)
                          (if (let-values (((a_335) (car d_332)))
                                (if (list? a_335)
                                  (let-values (((lst_122) a_335))
                                    (begin
                                      ...
                                      ((letrec-values (((for-loop_54)
                                                                                            ...
                                                                                            (let-values ()
                                                                                              (let-values ()
                                                                                                (if (pair? v_66)
                                                                                                  ...
                                                                                                  #f)))))
                                                                                (values result_58)))))
                                                                (if (if (not ((lambda x_16 (not result_57)) v_66))
                                                                      (not #f)
                                                                      #f)
                                                                  (for-loop_54 result_57 rest_65)
                                                                  result_57)))
                                                            result_56))))
                                         for-loop_54)
                                       #t
                                       lst_122)))
                                  #f))
                            (let-values (((d_336) (cdr d_332))) (list? d_336))
                            #f)
                          #f))
                      #f)
                    #f)
                (let-values (((ids_46 rhss_82 bodys_29)
                              (let-values (((d_337) (cdr v_63)))
                                (let-values (((ids_47 rhss_83)
                                              (let-values (((a_339) (car d_337)))
                                                (let-values (((ids_48 rhss_84)
                                                              (let-values (((lst_124) a_339))
                                                                (begin
                                                                  (if (list? lst_124)
                                                                    (void)
                                                                    (let-values () (check-list lst_124)))
                                                                  ((letrec-values (((for-loop_55)
                                                                                    (lambda (ids_49 rhss_85 lst_125)
                                                                                      (if (pair? lst_125)
                                                                                        (let-values (((v_67)
                                                                                                      (unsafe-car
                                                                                                       lst_125))
                                                                                          ...
                                                                                          (let-values (((ids_50 rhss_86)
                                                                                            ...
                                                                                            (if (not #f)
                                                                                              (for-loop_55
                                                                                               ...
                                                                                               rhss_86
                                                                                               rest_66)
                                                                                              (values ids_50 rhss_86))))
                                                                                        (values ids_49 rhss_85)))))
                                                                     for-loop_55)
                                                                   null
                                                                   null
                                                                   lst_124)))))
                                                  (values (reverse$1 ids_48) (reverse$1 rhss_84)))))
                                             ((bodys_30) (let-values (((d_339) (cdr d_337))) d_339)))
                                  (values ids_47 rhss_83 bodys_30)))))
                  (find-mutated* bodys_29 (find-mutated* rhss_82 mutated_31 pending_14) pending_14))
                (if (if (pair? v_63)
                      (if (let-values (((a_343) (car v_63))) (equal? 'letrec-values a_343))
                        (let-values (((d_340) (cdr v_63)))
                          (if (pair? d_340)
                            (if (let-values (((a_344) (car d_340)))
                                  (if (list? a_344)
                                    (let-values (((lst_126) a_344))
                                      (begin
                                        (if (list? lst_126) (void) (let-values () (check-list lst_126)))
                                        ((letrec-values (((for-loop_56)
                                                          (lambda (result_59 lst_127)
                                                            (if (pair? lst_127)
                                                              (let-values (((v_68) (unsafe-car lst_127))
                                                                                              ...
                                                                                              (let-values ()
                                                                                                (let-values ()
                                                                                                  (if (pair? v_68)
                                                                                                    ...
                                                                                                    #f)))))
                                                                                  (values result_61)))))
                                                                  (if (if (not ((lambda x_17 (not result_60)) v_68))
                                                                        (not #f)
                                                                        #f)
                                                                    (for-loop_56 result_60 rest_67)
                                                                    result_60)))
                                                              result_59))))
                                           for-loop_56)
                                         #t
                                         lst_126)))
                                    #f))
                              (let-values (((d_343) (cdr d_340))) (list? d_343))
                              #f)
                            #f))
                        #f)
                      #f)
                  (let-values (((idss_33 rhss_90 bodys_31)
                                (let-values (((d_344) (cdr v_63)))
                                  (let-values (((idss_34 rhss_91)
                                                (let-values (((a_347) (car d_344)))
                                                  (let-values (((idss_35 rhss_92)
                                                                (let-values (((lst_128) a_347))
                                                                  (begin
                                                                    (if (list? lst_128)
                                                                      (void)
                                               ...
                                               ((bodys_32) (let-values (((d_346) (cdr d_344))) d_346)))
                                    (values idss_34 rhss_91 bodys_32)))))
                                      ...
                                      ((letrec-values (((for-loop_58)
                                                        (lambda (mutated_36 simple-so-far?_1 lst_132 lst_133)
                                                          (if (if (pair? lst_132) (pair? lst_133) #f)
                                                            (let-values (((ids_54) (unsafe-car lst_132))
                                                                         ((rest_69) (unsafe-cdr lst_132))
                                                                         ((rhs_35) (unsafe-car lst_133))
                                                                         ((rest_70) (unsafe-cdr lst_133)))
                                       ...
                                       lst_130
                                       lst_131)))))
                      (find-mutated* bodys_31 new-mutated_0 pending_14)))
                  (if (if (pair? v_63)
                        (if (let-values (((a_350) (car v_63))) (equal? 'if a_350))
                          (let-values (((d_347) (cdr v_63)))
                            (if (pair? d_347)
                              (if (let-values (((a_351) (car d_347))) #t)
                                (let-values (((d_348) (cdr d_347)))
                                  (if (pair? d_348)
                                    (if (let-values (((a_352) (car d_348))) #t)
                                      (let-values (((d_349) (cdr d_348)))
                                        (if (pair? d_349)
                                          (if (let-values (((a_353) (car d_349))) #t)
                                            (let-values (((d_350) (cdr d_349))) (equal? '() d_350))
                                            #f)
                                          #f))
                                      #f)
                                    #f))
                    ...
                    (let-values (((tst_2 thn_3 els_3)
                                  (let-values (((d_351) (cdr v_63)))
                                    (let-values (((tst_3) (let-values (((a_354) (car d_351))) a_354))
                                                 ((thn_4 els_4)
                                                  (let-values (((d_352) (cdr d_351)))
                                                    (let-values (((thn_5) (let-values (((a_355) (car d_352))) a_355))
                                                                 ((els_5)
                                                                  (let-values (((d_353) (cdr d_352)))
                                                                    (let-values (((a_356) (car d_353))) a_356))))
                                                      (values thn_5 els_5)))))
                      ...
                      (find-mutated
                       ...
                       pending_14))
                    (if (if (pair? v_63)
                          (if (let-values (((a_357) (car v_63))) (equal? 'with-continuation-mark a_357))
                            (let-values (((d_354) (cdr v_63)))
                              (if (pair? d_354)
                                (if (let-values (((a_358) (car d_354))) #t)
                                  (let-values (((d_355) (cdr d_354)))
                                    (if (pair? d_355)
                                      (if (let-values (((a_359) (car d_355))) #t)
                                        (let-values (((d_356) (cdr d_355)))
                                          (if (pair? d_356)
                                            (if (let-values (((a_360) (car d_356))) #t)
                                              (let-values (((d_357) (cdr d_356))) (equal? '() d_357))
                                              #f)
                                            #f))
                                        #f)
                                      #f))
                            ...
                            #f)
                          #f)
                      (let-values (((key_2 val_3 body_22)
                                    (let-values (((d_358) (cdr v_63)))
                                      (let-values (((key_3) (let-values (((a_361) (car d_358))) a_361))
                                                   ((val_4 body_23)
                                                    (let-values (((d_359) (cdr d_358)))
                                                      (let-values (((val_5) (let-values (((a_362) (car d_359))) a_362))
                                                                   ((body_24)
                                                                    (let-values (((d_360) (cdr d_359)))
                                                                      (let-values (((a_363) (car d_360))) a_363))))
                                                        (values val_5 body_24)))))
                                        (values key_3 val_4 body_23)))))
                        (find-mutated
                         body_22
                         (find-mutated val_3 (find-mutated key_2 mutated_31 pending_14) pending_14)
                         pending_14))
                      (if (if (pair? v_63)
                            (if (let-values (((a_364) (car v_63))) (equal? 'begin a_364))
                              (let-values (((d_361) (cdr v_63))) (list? d_361))
                              #f)
                            #f)
                        (let-values (((exps_4) (let-values (((d_362) (cdr v_63))) d_362)))
                          (find-mutated* exps_4 mutated_31 pending_14))
                        (if (if (pair? v_63)
                              (if (let-values (((a_365) (car v_63))) (equal? 'begin0 a_365))
                                (let-values (((d_363) (cdr v_63))) (list? d_363))
                                #f)
                              #f)
                          (let-values (((exps_5) (let-values (((d_364) (cdr v_63))) d_364)))
                            (find-mutated* exps_5 mutated_31 pending_14))
                          (if (if (pair? v_63)
                                (if (let-values (((a_366) (car v_63))) (equal? 'set! a_366))
                                  (let-values (((d_365) (cdr v_63)))
                                    (if (pair? d_365)
                                      (if (let-values (((a_367) (car d_365))) #t)
                                        (let-values (((d_366) (cdr d_365)))
                                          (if (pair? d_366)
                                            (if (let-values (((a_368) (car d_366))) #t)
                                              (let-values (((d_367) (cdr d_366))) (equal? '() d_367))
                                              #f)
                                            #f))
                                        #f)
                                      #f))
                                  #f)
                                #f)
                            (let-values (((id_21 rhs_36)
                                          (let-values (((d_368) (cdr v_63)))
                                            (let-values (((id_22) (let-values (((a_369) (car d_368))) a_369))
                                                         ((rhs_37)
                                                          (let-values (((d_369) (cdr d_368)))
                                                            (let-values (((a_370) (car d_369))) a_370))))
                                              (values id_22 rhs_37)))))
                              (find-mutated rhs_36 (hash-set mutated_31 id_21 #t) pending_14))
                            (if (if (pair? v_63)
                                  (if (let-values (((a_371) (car v_63))) (equal? '#%variable-reference a_371))
                                    (let-values (((d_370) (cdr v_63))) #t)
                                    #f)
                                  #f)
                              (let-values () mutated_31)
                              (if (if (pair? v_63)
                                    (if (let-values (((a_372) (car v_63))) #t)
                                      (let-values (((d_371) (cdr v_63))) (list? d_371))
                                      #f)
                                    #f)
                                (let-values (((rator_2 exps_6)
                                              (let-values (((rator_3) (let-values (((a_373) (car v_63))) a_373))
                                                           ((exps_7) (let-values (((d_372) (cdr v_63))) d_372)))
      ...
      (begin
        ...
        ((letrec-values (((for-loop_60)
                          (lambda (mutated_45 lst_137)
                            (if (pair? lst_137)
                              (let-values (((v_70) (unsafe-car lst_137)) ((rest_72) (unsafe-cdr lst_137)))
                                (let-values (((mutated_46)
                                              (let-values (((mutated_47) mutated_45))
                                                (let-values (((mutated_48)
                                                  ...
                                                  (values mutated_48)))))
                                  (if (not #f) (for-loop_60 mutated_46 rest_72) mutated_46)))
                              mutated_45))))
           for-loop_60)
         mutated_44
         lst_136)))))
                                                ...
                                                (let-values (((assigns_3)
                                                              (let-values ()
                                                                (let-values (((v_72) v_71))
                                                                  (if (if (pair? v_72)
                                                                        (if (let-values (((a_374) (car v_72)))
                                                                              (equal? 'define-values a_374))
                                                                          (let-values (((d_373) (cdr v_72)))
                                                                            (if (pair? d_373)
                                                                              (if (let-values (((a_375) (car d_373)))
                                                                                    (list? a_375))
                                                                        ...
                                                                        #f)
                                                                    (let-values (((ids_55)
                                                                                  (let-values (((d_376) (cdr v_72)))
                                                                                    (let-values (((a_377) (car d_376)))
                                                                                      a_377))))
                                                                      (let-values (((lst_140) ids_55))
                                                                        (begin
                                                                          (if (list? lst_140)
                                                                            (void)
                                                  ...
                                                  (values assigns_3)))))
                                  (if (not #f) (for-loop_61 assigns_1 rest_73) assigns_1)))
                              assigns_0))))
           for-loop_61)
         null
         lst_138))))))
