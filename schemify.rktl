                                                                          ...
                                                                          (if e_1
                                                                            ...
                                                                            (list
                                                                             ...
                                                                             (if (hash-ref mutated_15 v_41 #f)
                                                                               ...
                                                                               'immutable)))))
                                                                      (if (if (pair? v_42)
                                                                            (if (let-values (((a_329) (car v_42))) #t)
                                                                              (let-values (((d_322) (cdr v_42)))
                                                                                (list? d_322))
                                                                              #f)
                                                                            #f)
                            ...
                            (let-values ()
                              (let-values (((form_0) (car l_13)))
                                (let-values (((v_59) form_0))
                                  (if (if (pair? v_59)
                                        (if (let-values (((a_336) (car v_59))) (equal? 'define-values a_336))
                                          (let-values (((d_329) (cdr v_59)))
                                            (if (pair? d_329)
                                              (if (let-values (((a_337) (car d_329))) #t)
                                                (let-values (((d_330) (cdr d_329)))
                                                  (if (pair? d_330)
                                                    (if (let-values (((a_338) (car d_330))) #t)
                                    ...
                                    (let-values (((ids_48 rhs_38)
                                                  (let-values (((d_332) (cdr v_59)))
                                                    (let-values (((ids_49) (let-values (((a_339) (car d_332))) a_339))
                                                                 ((rhs_39)
                                                                  (let-values (((d_333) (cdr d_332)))
                                                                    (let-values (((a_340) (car d_333))) a_340))))
 ...
 (define-values
  ...
  (lambda (v_62 mutated_31 pending_14)
    (let-values (((v_63) v_62))
      (if (if (pair? v_63)
            (if (let-values (((a_341) (car v_63))) (equal? 'lambda a_341))
              (let-values (((d_334) (cdr v_63)))
                (if (pair? d_334)
                  (if (let-values (((a_342) (car d_334))) #t) (let-values (((d_335) (cdr d_334))) (list? d_335)) #f)
                  #f))
              #f)
            #f)
        (let-values (((formals_3 body_21)
                      (let-values (((d_336) (cdr v_63)))
                        (let-values (((formals_4) (let-values (((a_343) (car d_336))) a_343))
                                     ((body_22) (let-values (((d_337) (cdr d_336))) d_337)))
                          (values formals_4 body_22)))))
          (find-mutated* body_21 mutated_31 pending_14))
        (if (if (pair? v_63)
              (if (let-values (((a_344) (car v_63))) (equal? 'case-lambda a_344))
                (let-values (((d_338) (cdr v_63)))
                  (if (list? d_338)
                    (let-values (((lst_118) d_338))
                      (begin
                        (check-list lst_118)
          ...
          (if (if (pair? v_63)
                    ...
                    (if (pair? d_342)
                      (if (let-values (((a_348) (car d_342))) #t)
                        (let-values (((d_343) (cdr d_342)))
                          (if (pair? d_343)
                            (if (let-values (((a_349) (car d_343))) #t)
                              (let-values (((d_344) (cdr d_343))) (equal? '() d_344))
                              #f)
                            #f))
                        #f)
                      #f))
            ...
            (let-values (((ids_50 rhs_40)
                          (let-values (((d_345) (cdr v_63)))
                            (let-values (((ids_51) (let-values (((a_350) (car d_345))) a_350))
                                         ((rhs_41)
                                          (let-values (((d_346) (cdr d_345)))
                                            (let-values (((a_351) (car d_346))) a_351))))
                              (values ids_51 rhs_41)))))
              (find-mutated rhs_40 mutated_31 pending_14))
            (if (if (pair? v_63)
                  (if (let-values (((a_352) (car v_63))) (equal? 'quote a_352))
                    (let-values (((d_347) (cdr v_63)))
                      (if (pair? d_347)
                        (if (let-values (((a_353) (car d_347))) #t)
                          (let-values (((d_348) (cdr d_347))) (equal? '() d_348))
                          #f)
                        #f))
                    #f)
                  #f)
              ...
              (if (if (pair? v_63)
                    (if (let-values (((a_354) (car v_63))) (equal? 'let-values a_354))
                      (let-values (((d_349) (cdr v_63)))
                        (if (pair? d_349)
                          (if (let-values (((a_355) (car d_349)))
                                (if (list? a_355)
                                  (let-values (((lst_124) a_355))
                                    (begin
                                      (check-list lst_124)
                                      ((letrec-values (((for-loop_55)
                                       ...
                                       lst_124)))
                                  #f))
                            (let-values (((d_353) (cdr d_349))) (list? d_353))
                            #f)
                          #f))
                      #f)
                    #f)
                (let-values (((ids_52 rhss_82 bodys_31)
                              (let-values (((d_354) (cdr v_63)))
                                (let-values (((ids_53 rhss_83)
                                              (let-values (((a_359) (car d_354)))
                                                (let-values (((ids_54 rhss_84)
                                                              (let-values (((lst_126) a_359))
                                                                (begin
                                                                  (check-list lst_126)
                                             ...
                                             ((bodys_32) (let-values (((d_356) (cdr d_354))) d_356)))
                                  (values ids_53 rhss_83 bodys_32)))))
                  (find-mutated* bodys_31 (find-mutated* rhss_82 mutated_31 pending_14) pending_14))
                (if (if (pair? v_63)
                      (if (let-values (((a_363) (car v_63))) (equal? 'letrec-values a_363))
                        (let-values (((d_357) (cdr v_63)))
                          (if (pair? d_357)
                            (if (let-values (((a_364) (car d_357)))
                                  (if (list? a_364)
                                    (let-values (((lst_128) a_364))
                                      (begin
                                        ...
                                        ((letrec-values (((for-loop_57)
                                         ...
                                         lst_128)))
                                    #f))
                              (let-values (((d_360) (cdr d_357))) (list? d_360))
                              #f)
                            #f))
                        #f)
                      #f)
                  (let-values (((idss_33 rhss_90 bodys_33)
                                (let-values (((d_361) (cdr v_63)))
                                  (let-values (((idss_34 rhss_91)
                                                (let-values (((a_367) (car d_361)))
                                                  (let-values (((idss_35 rhss_92)
                                                                (let-values (((lst_130) a_367))
                                                                  (begin
                                                                    (check-list lst_130)
                                               ...
                                               ((bodys_34) (let-values (((d_363) (cdr d_361))) d_363)))
                  ...
                  (if (if (pair? v_63)
                        (if (let-values (((a_370) (car v_63))) (equal? 'if a_370))
                          (let-values (((d_364) (cdr v_63)))
                            (if (pair? d_364)
                                  ...
                                  (if (pair? d_365)
                                    (if (let-values (((a_372) (car d_365))) #t)
                                      (let-values (((d_366) (cdr d_365)))
                                        (if (pair? d_366)
                                          (if (let-values (((a_373) (car d_366))) #t)
                    ...
                    (let-values (((tst_2 thn_3 els_3)
                                  (let-values (((d_368) (cdr v_63)))
                                    (let-values (((tst_3) (let-values (((a_374) (car d_368))) a_374))
                                                 ((thn_4 els_4)
                                                  (let-values (((d_369) (cdr d_368)))
                                                    (let-values (((thn_5) (let-values (((a_375) (car d_369))) a_375))
                                                                 ((els_5)
                                                                  (let-values (((d_370) (cdr d_369)))
                                                                    (let-values (((a_376) (car d_370))) a_376))))
                                                      (values thn_5 els_5)))))
                      ...
                      (find-mutated
                       ...
                       pending_14))
                    (if (if (pair? v_63)
                          (if (let-values (((a_377) (car v_63))) (equal? 'with-continuation-mark a_377))
                            (let-values (((d_371) (cdr v_63)))
                              (if (pair? d_371)
                                    ...
                                    (if (pair? d_372)
                                      (if (let-values (((a_379) (car d_372))) #t)
                                        (let-values (((d_373) (cdr d_372)))
                                          (if (pair? d_373)
                                            (if (let-values (((a_380) (car d_373))) #t)
                                              (let-values (((d_374) (cdr d_373))) (equal? '() d_374))
                                              #f)
                                            #f))
                                        #f)
                                      #f))
                      ...
                      (let-values (((key_2 val_3 body_24)
                                    (let-values (((d_375) (cdr v_63)))
                                      (let-values (((key_3) (let-values (((a_381) (car d_375))) a_381))
                                                   ((val_4 body_25)
                                                    (let-values (((d_376) (cdr d_375)))
                                                      (let-values (((val_5) (let-values (((a_382) (car d_376))) a_382))
                                                                   ((body_26)
                                                                    (let-values (((d_377) (cdr d_376)))
                                                                      (let-values (((a_383) (car d_377))) a_383))))
                        ...
                        (find-mutated
                         ...
                         pending_14))
                      (if (if (pair? v_63)
                            (if (let-values (((a_384) (car v_63))) (equal? 'begin a_384))
                              (let-values (((d_378) (cdr v_63))) (list? d_378))
                              #f)
                            #f)
                        (let-values (((exps_4) (let-values (((d_379) (cdr v_63))) d_379)))
                          (find-mutated* exps_4 mutated_31 pending_14))
                        (if (if (pair? v_63)
                              (if (let-values (((a_385) (car v_63))) (equal? 'begin0 a_385))
                                (let-values (((d_380) (cdr v_63))) (list? d_380))
                                #f)
                              #f)
                          (let-values (((exps_5) (let-values (((d_381) (cdr v_63))) d_381)))
                            (find-mutated* exps_5 mutated_31 pending_14))
                          (if (if (pair? v_63)
                                (if (let-values (((a_386) (car v_63))) (equal? 'set! a_386))
                                  (let-values (((d_382) (cdr v_63)))
                                    (if (pair? d_382)
                                      (if (let-values (((a_387) (car d_382))) #t)
                                        (let-values (((d_383) (cdr d_382)))
                                          (if (pair? d_383)
                                            (if (let-values (((a_388) (car d_383))) #t)
                                              (let-values (((d_384) (cdr d_383))) (equal? '() d_384))
                                              #f)
                                            #f))
                                        #f)
                                      #f))
                                  #f)
                                #f)
                            (let-values (((id_23 rhs_43)
                                          (let-values (((d_385) (cdr v_63)))
                                            (let-values (((id_24) (let-values (((a_389) (car d_385))) a_389))
                                                         ((rhs_44)
                                                          (let-values (((d_386) (cdr d_385)))
                                                            (let-values (((a_390) (car d_386))) a_390))))
                                              (values id_24 rhs_44)))))
                              (find-mutated rhs_43 (hash-set mutated_31 id_23 #t) pending_14))
                            (if (if (pair? v_63)
                                  (if (let-values (((a_391) (car v_63))) (equal? '#%variable-reference a_391))
                                    (let-values (((d_387) (cdr v_63))) #t)
                                    #f)
                                  #f)
                              (let-values () mutated_31)
                              (if (if (pair? v_63)
                                    (if (let-values (((a_392) (car v_63))) #t)
                                      (let-values (((d_388) (cdr v_63))) (list? d_388))
                                      #f)
                                    #f)
                                (let-values (((rator_2 exps_6)
                                              (let-values (((rator_3) (let-values (((a_393) (car v_63))) a_393))
                                                           ((exps_7) (let-values (((d_389) (cdr v_63))) d_389)))
                                                ...
                                                (let-values (((assigns_3)
                                                              (let-values ()
                                                                (let-values (((v_72) v_71))
                                                                  (if (if (pair? v_72)
                                                                        (if (let-values (((a_394) (car v_72)))
                                                                              (equal? 'define-values a_394))
                                                                          (let-values (((d_390) (cdr v_72)))
                                                                            (if (pair? d_390)
                                                                              (if (let-values (((a_395) (car d_390)))
                                                                                    (list? a_395))
                                                                        ...
                                                                        #f)
                                                                    (let-values (((ids_61)
                                                                                  (let-values (((d_393) (cdr v_72)))
                                                                                    (let-values (((a_397) (car d_393)))
                                                                                      a_397))))
